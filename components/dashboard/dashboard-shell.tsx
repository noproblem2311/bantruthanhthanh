...
export function DashboardShell({
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="container-page grid gap-4 py-4 sm:gap-5 sm:py-5 lg:grid-cols-[260px_1fr]">
        <aside className="sticky top-16 z-20 overflow-hidden rounded-lg border bg-white shadow-soft lg:top-20 lg:h-[calc(100vh-6rem)]">
